...
나다주 디자인 규칙(그림자 없음, 선은 `1.4px` 한 굵기, 모서리는 `4px` 한 반경)에
PIYO 디자인 툴키트의 색을 씌웠습니다.
...
글자는 Noto Sans KR 400·500·700이며 확장은 `fonts/` 의 woff2를 직접 씁니다
(오프라인에서도 뜹니다). 아이콘은 ぴよ先生 로고에서 얼굴만 잘라 썼습니다.
